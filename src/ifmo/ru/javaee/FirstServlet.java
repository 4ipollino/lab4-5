	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (username.equals("Michael") && password.equals("qwerty")) {
				out.println(username + "Welcome to Online Shopping!" + "<BR>");
					counter = 0;
			/* Создание сеанса дл? пользовател? и сохранение имени пользовател?. */
		...
		out.println("<FORM ACTION = http://localhost:8282/lab4/SecondSessionServlet METHOD=POST>");
